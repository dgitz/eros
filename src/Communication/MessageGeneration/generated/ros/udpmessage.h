...
/***Created on:2019-10-14 04:45:55.483729***/
#ifndef UDPMESSAGE_H
#define UDPMESSAGE_H
...
public:
	...
	std::string encode_ControlGroupValueUDP(double tov,std::string ControlGroupName,double Command,double Sense,double Error,double Error_perc,double Output);
private:
};
#endif