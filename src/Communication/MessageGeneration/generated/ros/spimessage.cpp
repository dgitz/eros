...
/***Created on:2019-09-30 19:51:03.880653***/
/***Target: Raspberry Pi ***/
...
int SPIMessageHandler::decode_Get_ANA_Port2SPI(unsigned char* inbuffer,int * length,uint16_t* Pin1_Value,uint16_t* Pin2_Value,uint16_t* Pin3_Value,uint16_t* Pin4_Value,uint16_t* Pin5_Value,uint16_t* Pin6_Value)
{
	int v_Pin1_Value = inbuffer[0]<<8;
	*Pin1_Value = v_Pin1_Value + inbuffer[1];
	int v_Pin2_Value = inbuffer[2]<<8;
