...
/***Created on:2017-11-22 07:33:54.253048***/
/***Target: Arduino ***/
...
public:
	...
	int decode_TestMessageCommandSerial(unsigned char* inpacket,unsigned char* value1,unsigned char* value2,unsigned char* value3,unsigned char* value4,unsigned char* value5,unsigned char* value6,unsigned char* value7,unsigned char* value8);
	...
	int encode_FirmwareVersionSerial(unsigned char* outbuffer,int* length,unsigned char majorVersion,unsigned char minorVersion,unsigned char buildNumber);
	...
	int encode_IDSerial(unsigned char* outbuffer,int* length,unsigned char DeviceID,unsigned long PartNumber);
	int encode_IMUSerial(unsigned char* outbuffer,int* length,unsigned long timemS,int counter,long AccX_mg,long AccY_mg,long AccZ_mg,long GyroX_mdegps,long GyroY_mdepgs,long GyroZ_mdegps,long MagX,long MagY,long MagZ);
private:
};
#endif