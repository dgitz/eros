...
/***Created on:2019-05-05 20:01:31.379742***/
#ifndef UDPMESSAGE_H
#define UDPMESSAGE_H
#include <QString>
#include <QList>
...
public:
	...
	int decode_SubsystemDiagnosticUDP(QList<QByteArray> items,int* Electrical,int* Software,int* Communications,int* Sensors,int* Actuators,int* Data_Storage,int* Remote_Control,int* Target_Acquisition,int* Power,int* Pose,int* Timing,int* System_Resource);
private:
};
#endif