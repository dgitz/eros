...
WINDOW* SystemMonitorUtility::create_newwin(int height, int width, int starty, int startx) {
    WINDOW* local_win;
...
ScreenCoordinatePixel SystemMonitorUtility::convertCoordinate(ScreenCoordinatePerc coord_perc,
                                                              uint16_t width_pix,
                                                              uint16_t height_pix) {
