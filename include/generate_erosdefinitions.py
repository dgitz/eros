...
def print_usage():
    ...
    print "Generate eROS_Definitions.py from header: python generate_erosdefinitions.py -g <Directory>, where Directory is the location where eROS_Definitions.h exists"
